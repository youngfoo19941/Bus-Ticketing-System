...
public class RetrieveBusInfo extends JFrame{
    ...
    static final String DEFAULT = "SELECT * FROM BUSINFORMATION";
    ...
    private class ReadListener implements ActionListener{
       ...
       try{ 
            ...
            query = "SELECT * FROM BUSINFORMATION WHERE BUSID= '"+filterText.getText()+"'";
            ...
            try {
                ...
                try {
                    ...
                    if(filterText.getText().equals(""))
                    {
                        JOptionPane.showMessageDialog(null, "Bus ID can't be empty !", "INVALID TYPE", JOptionPane.ERROR_MESSAGE);
                        filterText.setText("");
                    }
                    else{
